# Watch Services Page Specification - Goldwear Jewelers

## Overview
- **Target File**: `src/app/watch-services/page.tsx`
...
- padding: `60px 20px`
- text-align: `center`
- Title (H1, `Montserrat`, large bold white text: `"Watch Services"`)
- Subtitle (H2 / paragraph, `Montserrat`, medium white text)

---

## 2. Watch Offerings Grid
- display: `grid`
...
- Each service tile contains:
  ...
  - Accompanying local image on top or side (`/images/watch-battery.jpg`, etc.)
